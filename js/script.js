...
(function () {
  ...
  function renderNonUk(){
    ...
    var distinctCount = Object.keys(filtered.reduce(function(acc,r){ acc[(r.Investor||'').toLowerCase()]=1; return acc; },{})).length;
    html+='<div class="nonuk-sector-group">'+s+' ('+distinctCount+')</div>';
